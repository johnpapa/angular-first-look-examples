...
var characters_routing_1 = require('./characters.routing');
var CharactersModule = (function () {
    function CharactersModule() {
    }
    CharactersModule = __decorate([
        core_1.NgModule({
            imports: [common_1.CommonModule, forms_1.FormsModule, characters_routing_1.routing],
            exports: [],
            declarations: [characters_routing_1.routedComponents],
