...
var vehicles_routing_1 = require('./vehicles.routing');
var VehiclesModule = (function () {
    function VehiclesModule() {
    }
    VehiclesModule = __decorate([
        core_1.NgModule({
            imports: [common_1.CommonModule, forms_1.FormsModule, router_1.RouterModule, vehicles_routing_1.routing],
            declarations: [vehicles_routing_1.routedComponents],
